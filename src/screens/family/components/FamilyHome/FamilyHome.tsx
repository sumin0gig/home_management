...
function FamilyHome(): React.JSX.Element {
  ...
  return (
    <View style={styles.container}>
        ...
        {isEditingName ? (
          <View style={styles.editNameRow}>
            <TextInput
              ...
              autoFocus
            />
            <Pressable onPress={handleSaveName} disabled={isSaving} style={styles.saveButton}>
      ...
      <Pressable style={styles.leaveButton} onPress={handleLeave} disabled={isLeaving}>
        <Text style={styles.leaveButtonText}>{isLeaving ? '처리 중...' : '가족 떠나기'}</Text>
      </Pressable>
    </View>
  );
}
